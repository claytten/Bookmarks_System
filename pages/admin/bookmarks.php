        ...
        <div class="az-content-body az-content-body-profile">
          ...
          <div class="az-profile-body">
            <table id="datatable1" class="display responsive nowrap">
              ...
              <tbody>
              <?php
              $query = "SELECT users.username,users.id,count(DISTINCT bookmarks.id) AS bookmarks FROM users INNER JOIN history ON users.id = history.id_user INNER JOIN bookmarks ON bookmarks.star = history.id GROUP BY users.id;";
              ...
              ?>
                <tr>
                  ...
                  <td><a href="./detail_bookmark.php?id=<?php echo $row['id']?>"><i class="fa fa-eye"></i></a></td>
                </tr>
              <?php
              }
              ?>
