      ...
      <div class="container mn-ht-100p">
        ...
        <div class="az-content-body az-content-body-profile">
          ...
          <div class="az-profile-body">
            <h4>
            <a href="./history.php" style="color:black"><i class="fas fa-arrow-left"></i></a>
            Management Account History <?php echo $getNameUser ?></h4>
            <table id="datatable1" class="display responsive nowrap">
              <thead>
                <tr>
                  <th class="wd-15p">No</th>
                  <th class="wd-15p">Username Github</th>
              ...
              <tbody>
              <?php
              $query = "SELECT * FROM history WHERE id_user='$getIdUser'";
              ...
              ?>
                <tr>
                  ...
                  <td>
                      <a href="../../action/admin/delete_history.php?id=<?php echo $row['id']?>&id_user=<?php echo $getIdUser ?>">
